...
public class StackedBarChartDemo4 extends ApplicationFrame {
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        KeyToGroupMap map = new KeyToGroupMap("Product 1aaa");
        map.mapKeyToGroup("Product 1 (US)", "A");
        map.mapKeyToGroup("Product 1 (Europe)", "A");
        map.mapKeyToGroup("Product 1 (Asia)", "A");
        map.mapKeyToGroup("Product 1 (Middle East)", "A");
